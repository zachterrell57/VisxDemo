...
function ticker(year2, month2, week, day2, hour2, minute2) {
  ...
  function tickInterval(start, stop, count3) {
    ...
    if (i === 0)
      return millisecond_default.every(Math.max(tickStep2(start, stop, count3), 1));
  ...
  if ("nice" in config && typeof config.nice !== "undefined" && "nice" in scale) {
    ...
    if (typeof nice4 === "boolean") {
      ...
      if (typeof nice4 === "string") {
        ...
        var interval = nice4.interval, step = nice4.step;
...
function applyZero(scale, config) {
  if ("zero" in config && config.zero === true) {
    ...
    var _ref = isDescending ? [b, a] : [a, b], min3 = _ref[0], max3 = _ref[1];
...
function getTicks(scale, numTicks) {
  ...
  return s.domain().filter(function(_, index3, arr) {
    return numTicks == null || arr.length <= numTicks || index3 % Math.round((arr.length - 1) / numTicks) === 0;
  });
}
...
//# sourceMappingURL=chunk-YWCZHVPV.js.map
